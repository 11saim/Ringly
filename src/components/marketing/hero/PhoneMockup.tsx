...
export function PhoneMockup() {
  return (
    <div className="flex justify-center items-center w-full">
      <div className="relative w-[316px] h-[650px] max-[365px]:w-[calc(100vw-32px)] max-[365px]:h-[calc(650px*(100vw-32px)/316)] shrink-0">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[316px] h-[650px] origin-top max-[365px]:[transform:scale(calc((100vw-32px)/316))]">
          {/* Screen */}
          <div className="absolute left-[8px] top-[6px] w-[300px] h-[638px] bg-black rounded-[2.7rem] overflow-hidden z-0">
            {/* Dynamic Island */}
          ...
          <img
            ...
            alt="phone-mockup"
            className="absolute inset-0 w-[316px] h-[650px] pointer-events-none z-10"
          />
        </div>
      </div>
    </div>
